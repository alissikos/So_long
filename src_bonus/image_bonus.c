...
void	ft_init_window(t_data **game)
{
	...
	(*game)->win_ptr = mlx_new_window((*game)->mlx_ptr,
			(*game)->width * PIC_SIZE, (*game)->height * PIC_SIZE, "SO LONG BONUS");
}
...
//	}
//	if ((*game)->flag_right_left == 2)
//	{
		(*game)->pl00_l = mlx_xpm_file_to_image((*game)->mlx_ptr, "./assets/00_l.xpm", &img_width, &img_height);
		(*game)->pl01_l = mlx_xpm_file_to_image((*game)->mlx_ptr, "./assets/01_l.xpm", &img_width, &img_height);
		(*game)->pl02_l = mlx_xpm_file_to_image((*game)->mlx_ptr, "./assets/02_l.xpm", &img_width, &img_height);
		(*game)->pl03_l = mlx_xpm_file_to_image((*game)->mlx_ptr, "./assets/03_l.xpm", &img_width, &img_height);
		(*game)->pl04_l = mlx_xpm_file_to_image((*game)->mlx_ptr, "./assets/04_l.xpm", &img_width, &img_height);
		(*game)->pl05_l = mlx_xpm_file_to_image((*game)->mlx_ptr, "./assets/05_l.xpm", &img_width, &img_height);
//	}
}
